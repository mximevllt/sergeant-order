...
export async function estimatePrice(value: unknown): Promise<Estimate> {
  ...
  if (input.halfDays < recommended) warnings.push("La durée choisie est inférieure à la recommandation : l’équipe suivra vos priorités sans garantir toutes les tâches.");
